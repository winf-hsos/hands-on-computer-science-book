...
Im ersten Kapitel steigen wir gleich voll ein und schreiben unser erstes Programm. Unser Ziel ist es, eine LED nacheinander in allen Farben des Regenbogens leuchten zu lassen. Um dahin zu kommen, lernen wir in @sec-colors-control-led zuerst, wie man überhaupt eine LED aus einem Programm heraus steuern kann. In @sec-colors-light-and-colors werfen wir einen kurzen Blick auf Farben im allgemeinen und wie diese im Computer erzeugt werden. Dabei unterscheiden wir die additive von der subtraktiven Farbmischung. Danach bereiten wir uns in @sec-colors-pulsating-led auf den Regenbogenfarbverlauf vor, indem wir zuerst eine pulsierende LED programmieren. Wir lernen dann in @sec-colors-hue-circle, wie man mittels RGB-Farbcode überhaupt einen Regenbogen erzeugen kann und warum das für uns Menschen nützlich ist. Am Ende in @sec-colors-rainbow-led schreiben wir schließlich das Programm, das die LED in allen Farben des Regenbogens leuchten lässt.
...
## Erstes Programm: LED ansteuern {#sec-colors-control-led}
...
::: callout-tip
Das Codebeispiel aus diesem Abschnitt findet ihr auf [GitHub](https://github.com/winf-hsos/hands-on-computer-science-code/blob/main/chapter_01/1_1_first_program.py).
:::

## Licht und Farben {#sec-colors-light-and-colors}
...
## Pulsierende LED {#sec-colors-pulsating-led}
...
Und tatsächlich gibt es in der Programmierung eine bessere Möglichkeit, um sich wiederholende Abläufe abzubilden: die Schleife\index{Schleife}. In einem Fall, bei dem wir genau wissen, wie oft wir etwas wiederholen wollen, bietet sich eine Zählerschleife\index{Zählerschleife} an:
...
::: callout-tip
Das Codebeispiel aus diesem Abschnitt findet ihr auf [GitHub](https://github.com/winf-hsos/hands-on-computer-science-code/blob/main/chapter_01/1_3_pulsating_led.py).
:::

## Farbkreise {#sec-colors-hue-circle}
...
## Regenbogen-LED {#sec-colors-rainbow-led}
...
::: callout-tip
Das Codebeispiel aus diesem Abschnitt findet ihr auf [GitHub](https://github.com/winf-hsos/hands-on-computer-science-code/blob/main/chapter_01/1_5_rainbow_led.py).
:::
