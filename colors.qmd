...
|---|---|---|
| **Brick Viewer** | Bauteile | @sec-colors-experiment-setup |
| **RGB LED** | Bauteile | @sec-colors-experiment-setup |
...
| **Objekte** | Programmierung | @sec-colors-control-led |
...
| **LED** | Bauteile | @sec-colors-light-and-colors |
:::
...
Im ersten Schritt wollen wir die LED und ihre Funktionen testen! Das geht ganz leicht mit dem \gloss{Brick Viewer}{Ein Werkzeug zum schnellen Testen der Tinkerforge-Bauteile}{Bauteile}. Schließt zuerst den Master Brick über das USB-Kabel an euren Computer an und öffnet den Brick Viewer. Klickt dann auf den Connect-Button.
...
Wechselt nun zum Tab der \gloss{RGB LED}{Eine LED, die in verschiedenen Farben leuchten kann.}{Bauteile}. Hier könnt ihr auf unterschiedlichen Wegen die Farbe der LED einstellen. Mehr kann eine LED nicht!
