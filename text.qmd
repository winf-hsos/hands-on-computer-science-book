---
abstract: |
    Wir nutzen Computer ständig, um Texte zu schreiben – von der WhatsApp-Nachricht über E-Mails und Einladungen bis hin zur Bachelorarbeit. Wir tippen auf dem Smartphone, Tablet oder Computer. Aber habt ihr euch schon einmal gefragt, wie das genau funktioniert? Um das zu verstehen, machen wir einen kleinen Umweg.
abstract-title: ""
---
...
Der folgende Code baut die Berechnungslogik in den LED-Dimmer aus @sec-led-dimmer-part-2 ein, der nur eine Farbe (Weiß) beherrscht. Wir könnten ihn aber genau wie in @sec-led-dimmer-part-3 um weitere Farben erweitern:
...
Im folgenden @sec-images beschäftigen wir uns mit Bildern, wie Computer sie sehen, und wie ein Bild auf den Bildschirm kommt.